package QuanHeGiuaCacLop.quanlybanhang2;
...
public class Receipt implements Comparable<Receipt>{
    ...
    public Receipt(int n, String s, ArrayList<Client> a, ArrayList<Merchandise> b) {
        ...
        this.profit = (this.merchandise.getPrice() - this.merchandise.getPurchasePrice())*amount;
    }
    ...
    public String toString() {
        return code + " " + client.getName() + " " + client.getAddress() + " " + merchandise.getName() + " " + amount + " " + pay + " " + profit;
    }
    @Override
    public int compareTo(Receipt o) {
        if(o.profit > this.profit) return 1;
        else if(o.profit < this.profit) return -1;
        else return this.code.compareTo(o.code);
    }
}
